namespace MonoFrostTemplate.Code.Utils.Collision
{
    /// <summary>
    ...
    public class Collider
    {
        ...
        public RectangleF Box => new RectangleF(owner.position + positionOffset + new Vector2(directionalOffset, 0), size);
        public RectangleF Top => new RectangleF(owner.position + positionOffset + new Vector2(directionalOffset, -1), new Vector2(size.X, 1));
        public RectangleF Bottom => new RectangleF(owner.position + positionOffset + new Vector2(directionalOffset, size.Y), new Vector2(size.X, 1));
        public RectangleF Left => new RectangleF(owner.position + positionOffset + new Vector2(directionalOffset - 1, 0), new Vector2(1, size.Y));
        public RectangleF Right => new RectangleF(owner.position + positionOffset + new Vector2(directionalOffset + size.X, 0), new Vector2(1, size.Y));
    }
