namespace MonoFrostTemplate.Code.Utils.ScreenTransitions
{
    public class CircleTransition : ScreenTransition
    {
        ...
        {
            if (Game.Instance.Scene is InGame ig) target = (ig.player.position - ig.camera.position) * ig.camera.zoom;
